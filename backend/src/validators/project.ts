...
const urlOrNull = z.string().url().optional().nullable().or(z.literal('').transform(() => null));
const stringOrNull = z.string().optional().nullable().or(z.literal('').transform(() => null));
...
export const createProjectSchema = z.object({
  ...
  role: stringOrNull,
  timeline: stringOrNull,
  challenge: stringOrNull,
});
